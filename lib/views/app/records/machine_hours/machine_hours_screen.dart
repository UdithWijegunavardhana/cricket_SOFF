...
import '../../../_shared/loaders/records_loader.dart';
...
class _MachineHoursScreenState extends State<MachineHoursScreen> {
  final MachineHoursController _machineHoursController =
      Get.put(MachineHoursController());

  @override
  Widget build(BuildContext context) {
    return Obx(
      () => _machineHoursController.isLoading.isFalse ? RefreshIndicator(
        onRefresh: () async {
          _machineHoursController.isLoading.value = true;
          _machineHoursController.getMachineHours();
        },
        child: Container(
                        ...
                        Expanded(
                          child: GlowingOverscrollIndicator(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount:
                                  _machineHoursController.machineHours.length,
                              scrollDirection: Axis.vertical,
                              shrinkWrap: true,
                              itemBuilder: (context, index) {
                                return machineHoursRow(
                                    _machineHoursController.machineHours[index]
                                        ['date']!,
                                    _machineHoursController.machineHours[index]
                                        ['type']!,
                                    _machineHoursController.machineHours[index]
