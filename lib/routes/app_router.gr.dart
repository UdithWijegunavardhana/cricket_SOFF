...
import '../views/app/home/home_screen.dart' as _i6;
import '../views/app/home_base.dart' as _i4;
import '../views/app/profile/complete_profile_screen.dart' as _i3;
import '../views/app/profile/profile_screen.dart' as _i8;
import '../views/app/qr_code/qr_code_screen.dart' as _i5;
import '../views/app/records/records_screen.dart' as _i7;
...
class AppRouter extends _i9.RootStackRouter {
  ...
  final Map<String, _i9.PageFactory> pagesMap = {
    ...
    CompleteProfileRoute.name: (routeData) {
      ...
      return _i9.CustomPage<dynamic>(
          routeData: routeData,
          child: _i3.CompleteProfileScreen(key: args.key),
          transitionsBuilder: _i9.TransitionsBuilders.fadeIn,
          opaque: true,
          barrierDismissible: false);
    },
  ...
  List<_i9.RouteConfig> get routes => [
        ...
        _i9.RouteConfig(BookingRoute.name, path: 'bookings'),
        _i9.RouteConfig(CompleteProfileRoute.name, path: 'complete-profile'),
        _i9.RouteConfig(HomeBase.name, path: '/home-base', guards: [
          authGuard
        ], children: [
          _i9.RouteConfig('#redirect',
              path: '',
              ...
              redirectTo: 'qr-code',
              fullMatch: true),
          _i9.RouteConfig(QRCodeRoute.name,
              path: 'qr-code', parent: HomeBase.name),
          _i9.RouteConfig(HomeRoute.name, path: 'home', parent: HomeBase.name),
          _i9.RouteConfig(RecordsRoute.name,
...
/// generated route for
/// [_i2.BookingScreen]
class BookingRoute extends _i9.PageRouteInfo<BookingRouteArgs> {
  BookingRoute(
      {_i10.Key? key,
...
class CompleteProfileRoute extends _i9.PageRouteInfo<CompleteProfileRouteArgs> {
  CompleteProfileRoute({_i10.Key? key})
...
/// generated route for
/// [_i7.RecordsScreen]
class RecordsRoute extends _i9.PageRouteInfo<void> {
