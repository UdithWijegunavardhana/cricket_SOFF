...
class ApiConfig {
  ...
  factory ApiConfig.fromJson(Map<String, dynamic> json) => ApiConfig(
      ...
      customerApis:
          CustomerApis.fromJson(json['customer_apis'] as Map<String, dynamic>),
      pointsApis:
          PointsApis.fromJson(json['points_apis'] as Map<String, dynamic>),
      resourcesApis: ResourcesApis.fromJson(
          json['resources_apis'] as Map<String, dynamic>),
      scheduleApis:
          ScheduleApis.fromJson(json['schedule_apis'] as Map<String, dynamic>));
  ...
  int get hashCode =>
      baseApiUrl.hashCode ^
      customerApis.hashCode ^
      pointsApis.hashCode ^
      resourcesApis.hashCode ^
      scheduleApis.hashCode;
}
...
class CustomerApis {
  ...
  factory CustomerApis.fromJson(Map<String, dynamic> json) => CustomerApis(
        ...
        getMachineHoursByCustomerId:
            json['get_machine_hours_by_customer_id'].toString(),
  ...
  CustomerApis copyWith({
    ...
    String? deleteSoffCricket,
      ...
      CustomerApis(
          ...
          getMachineHoursByCustomerId:
              getMachineHoursByCustomerId ?? this.getMachineHoursByCustomerId,
  ...
  bool operator ==(Object other) =>
      ...
      other is CustomerApis &&
          ...
          deleteSoffCricket == other.deleteSoffCricket;

  @override
  int get hashCode =>
      getCustomerByEmail.hashCode ^
      getMachineHoursByCustomerId.hashCode ^
      saveCustomer.hashCode ^
      deleteSoffCricket.hashCode;
}
...
class PointsApis {
  ...
  factory PointsApis.fromJson(Map<String, dynamic> json) => PointsApis(
      getPointsByCustomerEmail:
          json['get_points_by_customer_email'].toString());

  Map<String, dynamic> toJson() =>
      {'get_points_by_customer_email': getPointsByCustomerEmail};

  PointsApis clone() =>
      PointsApis(getPointsByCustomerEmail: getPointsByCustomerEmail);

  PointsApis copyWith({String? getPointsByCustomerEmail}) => PointsApis(
        getPointsByCustomerEmail:
            getPointsByCustomerEmail ?? this.getPointsByCustomerEmail,
      );
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PointsApis &&
          getPointsByCustomerEmail == other.getPointsByCustomerEmail;
...
class ResourcesApis {
  ...
  factory ResourcesApis.fromJson(Map<String, dynamic> json) => ResourcesApis(
      ...
      getAllResourcesByCategoryId:
          json['get_all_resources_by_category_id'].toString());
  ...
  ResourcesApis copyWith(
      ...
      ResourcesApis(
        getAllResourceCategories:
            getAllResourceCategories ?? this.getAllResourceCategories,
        getAllResourcesByCategoryId:
            getAllResourcesByCategoryId ?? this.getAllResourcesByCategoryId,
      );
  ...
  @override
  int get hashCode =>
      getAllResourceCategories.hashCode ^ getAllResourcesByCategoryId.hashCode;
}
...
class ScheduleApis {
  ...
  ScheduleApis clone() => ScheduleApis(
      getSchedulesByDate: getSchedulesByDate, saveSchedule: saveSchedule);

  ScheduleApis copyWith({String? getSchedulesByDate, String? saveSchedule}) =>
      ScheduleApis(
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ScheduleApis &&
          getSchedulesByDate == other.getSchedulesByDate &&
          saveSchedule == other.saveSchedule;
